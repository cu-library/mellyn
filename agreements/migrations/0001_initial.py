...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': [('agreement_search_signatures', 'Can search signatures associated with this agreement')],
            },
        ),
        migrations.CreateModel(
            name='Department',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('low_codes_threshold', models.PositiveSmallIntegerField(default=51, help_text='If the number of unassigned license codes associated with this resource falls below this threshold, start emailing warnings.')),
                ('low_codes_email', models.CharField(blank=True, help_text='The recipient of email warnings about low numbers of remaning unassigned license codes.', max_length=200, validators=[django.core.validators.EmailValidator()])),
                ('hidden', models.BooleanField(default=False, help_text='Hidden resources do not appear in the list of active resources.')),
            ],
            options={
                'permissions': [('resource_view_file_access_stats', 'Can view the file access statistics associated with this resource'), ('resource_view_licensecodes', 'Can view the license codes associated with this resource'), ('resource_change_licensecodes', 'Can change the license codes associated with this resource')],
            },
        ),
        migrations.CreateModel(
            name='Signature',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('resource', 'path', 'session_key', 'at'), name='agreements_filedownloadevent_unique'),
        ),
        migrations.AddConstraint(
            model_name='department',
            constraint=models.UniqueConstraint(fields=('name', 'faculty'), name='agreements_department_unique_depts_in_faculty'),
        ),
        migrations.AddConstraint(
            model_name='agreement',
