...
urlpatterns = [  # pylint: disable=invalid-name
    ...
    path('resources/<slug:slug>/codes/', views.ResourceLicenseCode.as_view(), name='resources_codes'),
    path('resources/<slug:slug>/codes/add/', views.ResourceLicenseCodeAdd.as_view(), name='resources_codes_add'),
    ...
    path('agreements/<slug:slug>/permissions/groups/',
         views.AgreementPermissionsGroups.as_view(),
    ...
    path('signatures/', views.SignatureList.as_view(), name='signatures_list'),
    path('signatures/on/<slug:agreementslug>/',
         views.SignatureList.as_view(),
         name='signatures_for_agreement_list'),
    path('signatures/on/<slug:agreementslug>/csv/',
         views.SignatureCSV.as_view(),
         name='signatures_for_agreement_csv'),
]
